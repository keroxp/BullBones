...
var BinaryArrayTests = function() {
	haxe_unit_TestCase.call(this);
};
BinaryArrayTests.__name__ = ["BinaryArrayTests"];
BinaryArrayTests.__super__ = haxe_unit_TestCase;
BinaryArrayTests.prototype = $extend(haxe_unit_TestCase.prototype,{
	test1: function() {
		var bn = new performance_BinaryArray(64);
		bn[0] = true;
		bn[1] = false;
		bn[2] = true;
		bn[32] = true;
		bn[33] = false;
		bn[34] = true;
		this.assertTrue(bn[0],{ fileName : "BinaryArrayTests.hx", lineNumber : 15, className : "BinaryArrayTests", methodName : "test1"});
		this.assertFalse(bn[1],{ fileName : "BinaryArrayTests.hx", lineNumber : 16, className : "BinaryArrayTests", methodName : "test1"});
		this.assertTrue(bn[2],{ fileName : "BinaryArrayTests.hx", lineNumber : 17, className : "BinaryArrayTests", methodName : "test1"});
		this.assertTrue(bn[32],{ fileName : "BinaryArrayTests.hx", lineNumber : 18, className : "BinaryArrayTests", methodName : "test1"});
		this.assertFalse(bn[33],{ fileName : "BinaryArrayTests.hx", lineNumber : 19, className : "BinaryArrayTests", methodName : "test1"});
		this.assertTrue(bn[34],{ fileName : "BinaryArrayTests.hx", lineNumber : 20, className : "BinaryArrayTests", methodName : "test1"});
		bn[34] = false;
		this.assertFalse(bn[34],{ fileName : "BinaryArrayTests.hx", lineNumber : 22, className : "BinaryArrayTests", methodName : "test1"});
	}
	,test2: function() {
		var len = 1024;
		var arr = [];
		var bna = new performance_BinaryArray(len);
		var _g = 0;
		while(_g < len) {
			var i = _g++;
		...
		while(_g1 < _g2) {
			var i1 = _g1++;
			if(arr[i1] != bna[i1]) haxe_Log.trace("index is " + i1,{ fileName : "BinaryArrayTests.hx", lineNumber : 34, className : "BinaryArrayTests", methodName : "test2"});
			this.assertTrue(arr[i1] == bna[i1],{ fileName : "BinaryArrayTests.hx", lineNumber : 36, className : "BinaryArrayTests", methodName : "test2"});
		}
	}
	,__class__: BinaryArrayTests
});
...
ScalarTests.prototype = $extend(haxe_unit_TestCase.prototype,{
	...
	,testBase: function() {
		...
		s = this1;
		this.assertEquals(2 * util_BrowserUtil.dpr,s,{ fileName : "ScalarTests.hx", lineNumber : 16, className : "ScalarTests", methodName : "testBase"});
		var this2;
		this2 = geometry__$Scalar_Scalar_$Impl_$.conv(3);
		s = this2;
		this.assertEquals(3 * util_BrowserUtil.dpr,s,{ fileName : "ScalarTests.hx", lineNumber : 18, className : "ScalarTests", methodName : "testBase"});
		var this3;
		this3 = geometry__$Scalar_Scalar_$Impl_$.conv(-100);
		s = this3;
		this.assertEquals(-100 * util_BrowserUtil.dpr,s,{ fileName : "ScalarTests.hx", lineNumber : 20, className : "ScalarTests", methodName : "testBase"});
		var this4;
		this4 = geometry__$Scalar_Scalar_$Impl_$.conv(0.1);
		s = this4;
		this.assertEquals(0.1 * util_BrowserUtil.dpr,s,{ fileName : "ScalarTests.hx", lineNumber : 22, className : "ScalarTests", methodName : "testBase"});
	}
	,testAdd: function() {
		var _g = this;
		var s;
		...
		_g.assertEquals(e,(function($this) {
			...
			$r = this3;
			return $r;
		}(this)),{ fileName : "ScalarTests.hx", lineNumber : 30, className : "ScalarTests", methodName : "testAdd"});
		_g.assertEquals(e,(function($this) {
			var $r;
	...
	,testSub: function() {
		...
		_g.assertEquals(0 * util_BrowserUtil.dpr,(function($this) {
			...
			$r = this3;
			return $r;
		}(this)),{ fileName : "ScalarTests.hx", lineNumber : 43, className : "ScalarTests", methodName : "testSub"});
		_g.assertEquals(0 * util_BrowserUtil.dpr,(function($this) {
			var $r;
	...
	,testMul: function() {
		...
		this2 = geometry__$Scalar_Scalar_$Impl_$.conv(2);
		t = this2;
		_g.assertEquals(4 * util_BrowserUtil.dpr,s * 2,{ fileName : "ScalarTests.hx", lineNumber : 56, className : "ScalarTests", methodName : "testMul"});
		_g.assertEquals(2 * util_BrowserUtil.dpr * (2 * util_BrowserUtil.dpr),(function($this) {
			...
			$r = this3;
			return $r;
		}(this)),{ fileName : "ScalarTests.hx", lineNumber : 57, className : "ScalarTests", methodName : "testMul"});
		_g.assertEquals(2 * util_BrowserUtil.dpr * (2 * util_BrowserUtil.dpr),(function($this) {
			var $r;
		...
		t1 = this6;
		_g.assertEquals(-50 * util_BrowserUtil.dpr,s1 * 5,{ fileName : "ScalarTests.hx", lineNumber : 56, className : "ScalarTests", methodName : "testMul"});
		...
		t2 = this10;
		_g.assertEquals(10.35 * util_BrowserUtil.dpr,s2 * 2.3,{ fileName : "ScalarTests.hx", lineNumber : 56, className : "ScalarTests", methodName : "testMul"});
	...
	,testDiv: function() {
		...
		this2 = geometry__$Scalar_Scalar_$Impl_$.conv(2);
		t = this2;
		_g.assertEquals(util_BrowserUtil.dpr,s / 2,{ fileName : "ScalarTests.hx", lineNumber : 69, className : "ScalarTests", methodName : "testDiv"});
		_g.assertEquals(2 * util_BrowserUtil.dpr / (2 * util_BrowserUtil.dpr),(function($this) {
			var $r;
			var this3 = geometry__$Scalar_Scalar_$Impl_$.div(s,t);
			$r = this3;
			return $r;
		}(this)),{ fileName : "ScalarTests.hx", lineNumber : 70, className : "ScalarTests", methodName : "testDiv"});
		_g.assertEquals(2 * util_BrowserUtil.dpr / (2 * util_BrowserUtil.dpr),(function($this) {
			var $r;
		...
		this6 = geometry__$Scalar_Scalar_$Impl_$.conv(5);
		t1 = this6;
		_g.assertEquals(-2. * util_BrowserUtil.dpr,s1 / 5,{ fileName : "ScalarTests.hx", lineNumber : 69, className : "ScalarTests", methodName : "testDiv"});
		_g.assertEquals(-10 * util_BrowserUtil.dpr / (5 * util_BrowserUtil.dpr),(function($this) {
			var $r;
		...
		this10 = geometry__$Scalar_Scalar_$Impl_$.conv(2.3);
		t2 = this10;
		_g.assertEquals(1.95652173913043503 * util_BrowserUtil.dpr,s2 / 2.3,{ fileName : "ScalarTests.hx", lineNumber : 69, className : "ScalarTests", methodName : "testDiv"});
		_g.assertEquals(4.5 * util_BrowserUtil.dpr / (2.3 * util_BrowserUtil.dpr),(function($this) {
			var $r;
...
var performance_BinaryArray = function(size) {
	this.mArray = new Uint32Array(Math.ceil(size / 32));
};
performance_BinaryArray.__name__ = ["performance","BinaryArray"];
performance_BinaryArray.prototype = {
	mArray: null
	,get: function(i) {
		var idx = Math.floor(i / 32);
		if(idx >= this.mArray.length) throw new Error("index is out of range. current length is " + this.mArray.length + " but got " + idx);
		return (this.mArray[idx] >>> i % 32 & 1) == 1;
	}
	,set: function(i,flag) {
		var idx = Math.floor(i / 32);
		if(idx >= this.mArray.length) throw new Error("index out of range. current length is " + this.mArray.length + " but got " + idx);
		if(flag) this.mArray[idx] |= 1; else this.mArray[idx] |= 0 << i % 32;
		return flag;
	}
	,__class__: performance_BinaryArray
};
...
util_BrowserUtil._isMobile = function() {
	return !util_BrowserUtil._isBrowser();
};
util_BrowserUtil._isBrowser = function() {
	return !util_BrowserUtil._isMobilePhone() && !util_BrowserUtil._isTablet();
};
util_BrowserUtil._isMobilePhone = function() {
...
util_BrowserUtil._isTablet = function() {
	var u = util_BrowserUtil.ua();
...
util_BrowserUtil._isFireFox = function() {
	return util_BrowserUtil.ua().indexOf("firefox") > -1;
};
util_BrowserUtil._isWebKit = function() {
...
performance_BinaryArray.__meta__ = { fields : { set : { arrayAccess : null}}};
...
util_BrowserUtil.isMobilePhone = util_BrowserUtil._isMobilePhone();
util_BrowserUtil.isMobile = util_BrowserUtil._isMobile();
util_BrowserUtil.isBrowser = util_BrowserUtil._isBrowser();
util_BrowserUtil.isTablet = util_BrowserUtil._isTablet();
util_BrowserUtil.isFireFox = util_BrowserUtil._isFireFox();
util_BrowserUtil.isWebKit = util_BrowserUtil._isWebKit();
TestMain.main();
